...
- [802.1Q](#8021q)
- [802.1X](#8021x)
- [Accumulator Register (EAX/RAX)](#accumulator-register-eaxrax)
- [Address Space Layout Randomization (ASLR)](#address-space-layout-randomization-aslr)
- [AES](#aes)
- [Alternative Payloads](#alternative-payloads)
- [American Fuzzy Lop (AFL)](#american-fuzzy-lop-afl)
- [AppArmor](#apparmor)
- [AppLocker](#applocker)
- [ARP Spoofing](#arp-spoofing)
- [Backup Designated Router (BDR)](#backup-designated-router-bdr)
- [BetterCap](#bettercap)
- [Blowfish](#blowfish)
- [BooFuzz](#boofuzz)
- [brk()](#brk)
...
- [captive portal scam](#captive-portal-scam)
- [chunk](#chunk)
- [Cipher Block Chaining (CBC)](#cipher-block-chaining-cbc)
- [Cisco Discovery Protocol (CDP)](#cisco-discovery-protocol-cdp)
- [Code Segment (CS)](#code-segment-cs)
- [COMB](#comb)
...
- [cpscam](#cpscam)
- [crashbin_explorer.py](#crashbin-explorerpy)
- [Data Encryption Standard (DES)](#data-encryption-standard-des)
- [Data Execution Prevention (DEP)](#data-execution-prevention-dep)
- [Data Register (EDX/RDX)](#data-register-edxrdx)
- [Data Segment (DS)](#data-segment-ds)
- [Debugging](#debugging)
...
- [Dynamips](#dynamips)
- [DynamoRIO](#dynamorio)
- [dynapstalker](#dynapstalker)
- [EAP Shadow Attack](#eap-shadow-attack)
- [EAP type](#eap-type)
- [EAX/RAX](#eaxrax)
- [EDX/RDX](#edxrdx)
...
- [Executable and Linking Format (ELF)](#executable-and-linking-format-elf)
- [Extra Segment (ES)](#extra-segment-es)
- [free()](#free)
- [Fuzzing](#fuzzing)
- [Gadgets](#gadgets)
...
- [IPv6](#ipv6)
- [IV Collision](#iv-collision)
- [JavaScript OS Validation](#javascript-os-validation)
...
- [Linker](#linker)
- [linux-gate.so.1](#linux-gateso1)
- [Loader](#loader)
- [Loki](#loki)
- [Low Fragmentation Heap (LFH)](#low-fragmentation-heap-lfh)
- [ltrace](#ltrace)
- [MAC](#mac)
- [MAC address](#mac-address)
- [MAC OUI](#mac-oui)
- [Magic Unicorn](#magic-unicorn)
- [MemGC](#memgc)
...
- [modprobe](#modprobe)
- [mona.py](#monapy)
- [Netmon Agent](#netmon-agent)
- [Netwide Assembler (NASM)](#netwide-assembler-nasm)
...
- [Padding Oracle On Downgraded Legacy Encryption (POODLE)](#padding-oracle-on-downgraded-legacy-encryption-poodle)
- [Paging](#paging)
- [PaiMei](#paimei)
- [Passive OS Fingerprinting](#passive-os-fingerprinting)
- [PaX](#pax)
- [Pcaphistogram](#pcaphistogram)
- [PE/COFF](#pecoff)
- [PEB Randomization](#peb-randomization)
- [Pickupline](#pickupline)
- [PKCS#5](#pkcs5)
- [PKCS#7](#pkcs7)
- [Pop/Pop/Ret](#poppopret)
- [post exploitation](#post-exploitation)
- [Potato](#potato)
- [PowerShell](#powershell)
- [PowerSploit](#powersploit)
- [Procedure Epilogue](#procedure-epilogue)
- [Procedure Linkage Table (PLT)](#procedure-linkage-table-plt)
- [Procedure Prologue](#procedure-prologue)
...
- [Procmon Agent](#procmon-agent)
- [Product Security Testing](#product-security-testing)
...
- [RC4](#rc4)
- [readelf](#readelf)
- [Request For Comment (RFC) documents](#request-for-comment-rfc-documents)
- [Restricted Desktops](#restricted-desktops)
- [ret2libc](#ret2libc)
...
- [Stack Pointer (ESP/RSP)](#stack-pointer-esprsp)
- [Stream Cipher IV Collision](#stream-cipher-iv-collision)
- [Stream ciphers](#stream-ciphers)
- [Structured Exception Handling (SEH)](#structured-exception-handling-seh)
- [Sulley](#sulley)
- [Swap](#swap)
- [Taof](#taof)
- [TCP Stack Fingerprinting](#tcp-stack-fingerprinting)
- [tcpick](#tcpick)
- [TFTP](#tftp)
- [theC2Matrix Project](#thec2matrix-project)
- [Thread Environment Block (TEB)](#thread-environment-block-teb)
- [Thread Information Block (TIB)](#thread-information-block-tib)
- [Triple DES (3DES)](#triple-des-3des)
- [Twofish](#twofish)
- [unlink()](#unlink)
- [User Account Control (UAC)](#user-account-control-uac)
- [User Impersonation](#user-impersonation)
- [User-Agent Impersonation](#user-agent-impersonation)
- [vconfig](#vconfig)
...
- [VLAN Manipulation](#vlan-manipulation)
- [Voice VLAN](#voice-vlan)
- [voiphopper](#voiphopper)
- [W^X](#wx)
- [Web Browser User-Agent Matching](#web-browser-user-agent-matching)
- [WinAFL](#winafl)
- [WinDBG](#windbg)
- [Wireshark](#wireshark)
- [WOW64](#wow64)
...
## COMB
- **1:21** — Compilation of Many Breaches are password lists, often sketchy
...
- **1:14** — Exploit Mitigation Control
- **4:92** — 
- **4:110** — 
- **4:122** — 
- **5:4** — 
...
## MAC
### Changing
- **1:45** — Macshift on windows, Ifconfig on *nix. Most cloud denies
...
## MAC OUI
- **1:47-48** — Organizationally Unique Identifiers (classes of devices)
...
## Pickupline
- **1:46** — Captive Portal scammer script
...
## post exploitation
- **1:18** — Anything after the first exploit
- **2:101** — 
...
- **1:14** — Technique to circumvent exploit mitigation controls
- **4:92** — 
- **4:116-117** — 
- **4:121-122** — 
- **4:124** — 
...
## theC2Matrix Project
- **1:18** — Jorge Orchilles list of C2 platforms
...
## User Impersonation
- **1:44** — Bypassing Captive Portals
